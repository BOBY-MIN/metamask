...
export function ContractCall() {
    ...
    useEffect(() => {
        ...
        const getGreeting = async (greetingContract) => {

            const _greeting = await greetingContract.greet();
            if(_greeting !== greeting) setGreeting(_greeting);
        }
    ...
    const handleDeployContract = (event) => {
        ...
        const deployGreetingContract = async () => {
            ...
            try{
                ...
                const greetingContract = await Greeting.deploy('Hello, Test');
    ...
    const handleGreetingSubmit = (event) => {
        ...
        if(!greetingContract) {
            window.alert('Error : undefined greeting contract');
            return;
        }
        ...
        const submitGreeting = async (greetingContract) => {
    ...
    return (
        <>
            ...
            <StyledGreetingDiv>
                ...
                <div>
                    {
                        greetingContractAddr ? greetingContractAddr : 'Contract not yet deployed'
                    }
                </div>
            </StyledGreetingDiv>
            <StyledGreetingDiv>
